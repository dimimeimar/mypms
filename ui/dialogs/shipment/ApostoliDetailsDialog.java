...
import org.example.ui.panels.shipment.ApostoliDetailsInfoPanel;
import org.example.ui.panels.shipment.ApostoliDetailsTrackingPanel;
import org.example.ui.components.managers.ApostoliDetailsDataManager;
...
public class ApostoliDetailsDialog extends JDialog {
    ...
    private void setupLayout() {
        ...
        if (apostoli != null) {
            ...
            ApostoliDetailsStatusMyPMSPanel statusMyPMSPanel =
                    new ApostoliDetailsStatusMyPMSPanel(this, apostoli, apostoliDAO);
            tabbedPane.addTab("Status MyPMS", statusMyPMSPanel);
