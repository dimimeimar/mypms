package org.example.view.client.panels;

import org.example.dao.EtairiaDAO;
import org.example.model.Etairia;
...
public class AddressContactPanel extends JPanel {
    ...
    private boolean isValidPostalCode(String tk) {
        if (tk == null || tk.trim().isEmpty()) {
            return true; // Empty is valid (optional field)
        }
        return tk.matches("\\d{5}");
    }
